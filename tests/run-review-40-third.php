...
$tests['40 third review evidence CI and manifests are locked']=static function()use($read):void{$c=$read('composer.json');$ci=$read('.github/workflows/ci.yml');$m=$read('manifests/cf03-release-1.2.0.json');containsR3($c,'run-review-40-third.php');containsR3($ci,'run-review-40-third.php');containsR3($ci,'run-review-40-fourth.php');containsR3($m,'1.2.0-rc.3');};
