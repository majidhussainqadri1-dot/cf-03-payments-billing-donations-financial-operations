...
$tests['complete schema version and table count are final']=static function():void{sameFT('3.1.0',CompleteSchema::VERSION);sameFT(31,count(CompleteSchema::tables('wp_')));};
