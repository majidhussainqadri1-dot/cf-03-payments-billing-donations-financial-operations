...
$tests=[];
$now=new DateTimeImmutable('2026-08-04T22:02:00+05:00');
...
$tests['complete schema version and table count are final']=static function():void{sameFT('3.2.0',CompleteSchema::VERSION);sameFT(31,count(CompleteSchema::tables('wp_')));};
...
$tests['complete schema enforces audit serialization and settlement duties']=static function():void{$tables=CompleteSchema::tables('wp_');sameFT(true,str_contains($tables['audit'],'UNIQUE KEY previous_hash(previous_hash)'));sameFT(true,str_contains($tables['settlements'],'imported_by varchar(191) NOT NULL'));};
