...
final class TransparencySchema
{
    ...
    public static function tables(string $prefix): array
    {
        ...
        return [
            ...
            'transparency_snapshots' => "CREATE TABLE {$prefix}sabri_cf03_transparency_snapshots (id bigint unsigned NOT NULL AUTO_INCREMENT, snapshot_id varchar(128) NOT NULL, period_key varchar(32) NOT NULL, currency char(3) NOT NULL, snapshot_json longtext NOT NULL, source_hash char(64) NOT NULL, snapshot_hash char(64) NOT NULL, publication_state varchar(32) NOT NULL, published_at datetime(6) NULL, created_at datetime(6) NOT NULL, PRIMARY KEY(id), UNIQUE KEY snapshot_id(snapshot_id), UNIQUE KEY period_currency(period_key,currency), KEY publication(publication_state,published_at)) {$charset};",
