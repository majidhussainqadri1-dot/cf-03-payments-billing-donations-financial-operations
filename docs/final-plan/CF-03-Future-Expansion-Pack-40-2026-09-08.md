...
**Written-plan amendment:** `v1.1`  
**Amendment date:** `09 September 2026`  
...
**Current hardened carrier:** `1.4.0-rc.5` / schema `4.0.2`; Future40 financial law and activation boundaries are unchanged.  
